...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVideoVideoPlayerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "canSetTimeUpdateMode", _g_get_canSetTimeUpdateMode);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new UnityEngine.Video.VideoPlayer();
		    ...
		    try {
                ...
                
                {
                    ushort _trackIndex = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAudioLanguageCode( _trackIndex );
		    ...
		    try {
                ...
                
                {
                    ushort _trackIndex = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAudioChannelCount( _trackIndex );
		    ...
		    try {
                ...
                
                {
                    ushort _trackIndex = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAudioSampleRate( _trackIndex );
		    ...
		    try {
                ...
                
                {
                    ushort _trackIndex = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.IsAudioTrackEnabled( _trackIndex );
		    ...
		    try {
                ...
                
                {
                    ushort _trackIndex = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetDirectAudioVolume( _trackIndex );
		    ...
		    try {
                ...
                
                {
                    ushort _trackIndex = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetDirectAudioMute( _trackIndex );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ushort _trackIndex = (ushort)LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetTargetAudioSource( _trackIndex );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_canSetTimeUpdateMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
