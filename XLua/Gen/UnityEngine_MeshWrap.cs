...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineMeshWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetIndexBuffer", _m_GetIndexBuffer);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetBoneWeightBuffer", _m_GetBoneWeightBuffer);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetBlendShapeBuffer", _m_GetBlendShapeBuffer);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetBlendShapeBufferRange", _m_GetBlendShapeBufferRange);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "indexBufferTarget", _g_get_indexBufferTarget);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "blendShapeCount", _g_get_blendShapeCount);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "bindposeCount", _g_get_bindposeCount);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "skinWeightBufferLayout", _g_get_skinWeightBufferLayout);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "indexBufferTarget", _s_set_indexBufferTarget);
        ...
        static int _m_GetBindposes(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetBindposes(  );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Collections.Generic.List<UnityEngine.Matrix4x4>>(L, 2)) 
                {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Mesh.GetBindposes!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetBindposes(RealStatePtr L)
        {
		    try {
                ...
                {
                    Unity.Collections.NativeArray<UnityEngine.Matrix4x4> _poses;translator.Get(L, 2, out _poses);
                    
                    gen_to_be_invoked.SetBindposes( _poses );
        ...
        static int _m_AllocateWritableMeshData_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Mesh>(L, 1)) 
                {
                    UnityEngine.Mesh _mesh = (UnityEngine.Mesh)translator.GetObject(L, 1, typeof(UnityEngine.Mesh));
                        ...
                        var gen_ret = UnityEngine.Mesh.AllocateWritableMeshData( _mesh );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<UnityEngine.Mesh[]>(L, 1)) 
                {
                    UnityEngine.Mesh[] _meshes = (UnityEngine.Mesh[])translator.GetObject(L, 1, typeof(UnityEngine.Mesh[]));
                        ...
                        var gen_ret = UnityEngine.Mesh.AllocateWritableMeshData( _meshes );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Mesh.AllocateWritableMeshData!");
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetVertexBuffer( _index );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetIndexBuffer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetIndexBuffer(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetBoneWeightBuffer(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.SkinWeights _layout;translator.Get(L, 2, out _layout);
                    
                        var gen_ret = gen_to_be_invoked.GetBoneWeightBuffer( _layout );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetBlendShapeBuffer(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetBlendShapeBuffer(  );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Rendering.BlendShapeBufferLayout>(L, 2)) 
                {
                    UnityEngine.Rendering.BlendShapeBufferLayout _layout;translator.Get(L, 2, out _layout);
                    
                        var gen_ret = gen_to_be_invoked.GetBlendShapeBuffer( _layout );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Mesh.GetBlendShapeBuffer!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetBlendShapeBufferRange(RealStatePtr L)
        {
		    try {
                ...
                {
                    int _blendShapeIndex = LuaAPI.xlua_tointeger(L, 2);
                    
                        var gen_ret = gen_to_be_invoked.GetBlendShapeBufferRange( _blendShapeIndex );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_indexBufferTarget(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Mesh gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.indexBufferTarget);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_bindposeCount(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Mesh gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.bindposeCount);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_skinWeightBufferLayout(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Mesh gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.skinWeightBufferLayout);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_indexBufferTarget(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
                ...
                UnityEngine.Mesh gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                UnityEngine.GraphicsBuffer.Target gen_value;translator.Get(L, 2, out gen_value);
				gen_to_be_invoked.indexBufferTarget = gen_value;
