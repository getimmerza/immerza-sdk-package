...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineColliderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 3, 14, 10);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "GeometryHolder", _g_get_GeometryHolder);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_GeometryHolder(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Collider gen_to_be_invoked = (UnityEngine.Collider)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.GeometryHolder);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_sharedMaterial(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Collider gen_to_be_invoked = (UnityEngine.Collider)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sharedMaterial = (UnityEngine.PhysicsMaterial)translator.GetObject(L, 2, typeof(UnityEngine.PhysicsMaterial));
        ...
        static int _s_set_material(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Collider gen_to_be_invoked = (UnityEngine.Collider)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.material = (UnityEngine.PhysicsMaterial)translator.GetObject(L, 2, typeof(UnityEngine.PhysicsMaterial));
